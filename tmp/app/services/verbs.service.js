...
var VerbsService = (function () {
    ...
    VerbsService.prototype.getVerb = function () {
        this.verbs = this.http.get(this.verbsUrl)
            .map(this.extractData)
            .catch(this.handleError);
        return this.verbs[0];
    };
    VerbsService.prototype.addVerb = function (newVerb) {
    ...
    VerbsService.prototype.extractData = function (res) {
    ...
    VerbsService.prototype.handleError = function (error) {

...
var FinderComponent = (function () {
    ...
    FinderComponent = __decorate([
        core_1.Component({
            ...
            directives: [finderGame_component_1.FinderGameComponent, menu_service_1.MenuService],
            providers: [router_1.ROUTER_PROVIDERS]
        }), 
        __metadata('design:paramtypes', [menu_service_1.MenuService, router_2.Router])
    ], FinderComponent);
